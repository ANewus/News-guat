<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="passtougao.aspx.cs" Inherits="News.WEB.admin.passtougao" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <span class="input-group-addon">投稿人</span>
...
<div class="form-group">
           <asp:Button ID="Button1" runat="server" Text="通过投稿" class="btn btn-primary" OnClick="Button1_Click"/>&nbsp;
    <asp:Button ID="Button2" runat="server" Text="删除投稿" class="btn btn-danger" OnClick="Button2_Click1"/>
    </div>
     </div>
    </form>
