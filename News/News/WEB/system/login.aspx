<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="News.WEB.system.login" %>
...
<form class="form-signin" runat="server">
  ...
  <div class="checkbox mb-3">
    ...
    <br />
    <a href="register.aspx" target="_blank">No account? Go to register</a>
    <br />
     <a href="../user/retrieve_password.aspx" target="_blank">Forgot your password? Reset</a>
    <br />
    <br />
    <br />
    <br />
