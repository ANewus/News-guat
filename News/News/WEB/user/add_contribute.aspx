<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_contribute.aspx.cs" Inherits="News.WEB.user.contribute" %>
...
<div class="form-group">
           <asp:Button ID="Button1" runat="server" Text="投稿" class="btn btn-default" OnClick="Button1_Click"/>
    </div>
     </div>
    </form>
