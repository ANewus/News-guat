<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_contribute.aspx.cs" Inherits="News.WEB.user.update_contribute" %>
...
<div class="form-group">
           <asp:Button ID="Button1" runat="server" Text="更新稿件" class="btn btn-primary" OnClick="Button1_Click"/>&nbsp;
    <asp:Button ID="Button2" runat="server" Text="删除稿件" class="btn btn-danger" OnClick="Button2_Click1"/>
    </div>
     </div>
    </form>
